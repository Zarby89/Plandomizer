...
{
    public static class PotListing
    {
        ...
        public static void randomizePots()
        {
            Random r = new Random();
            foreach (GameRoom g in roomList)
            {
                ...
                itemPointer[2] = 01;//
                itemPointer[0] = Form1.ROM_DATA[(0xDB67 + ((int)g.id * 2)) + 0];
                itemPointer[1] = Form1.ROM_DATA[(0xDB67 + ((int)g.id * 2)) + 1];
                ...
                {
                    Form1.ROM_DATA[addr + (i * 3) + 0] = roomPots[i].x;
                    Form1.ROM_DATA[addr + (i * 3) + 1] = roomPots[i].y;
                    Form1.ROM_DATA[addr + (i * 3) + 2] = roomPots[i].id;
                }
